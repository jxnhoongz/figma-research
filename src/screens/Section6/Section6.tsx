...
// Bundle every exported Section 6 asset; resolve scene `src` filenames to URLs.
const assetUrls = import.meta.glob('../../assets/section6/img/*', {
  eager: true,
  query: '?url',
  import: 'default',
...
// One scene per theme variant (升级模式-theme1…theme6), keyed by file stem so
// the screen swaps the whole composition on theme switch.
...
/**
 * 升级模式 (upgrade mode), Section 6. Six theme variants reconstructed 1:1 from
 * the plugin export; `themeId` selects the variant's scene. Presentational.
 */
